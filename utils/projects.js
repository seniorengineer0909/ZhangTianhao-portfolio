const projects = [
  ...
  },
  {
    ...
    title: 'Rails Recipe App ',
    image: '/work-10.jpeg',
    imageAlt: 'Learning site',
    description: 'This learning platform is designed to help users develop web development skills through interactive tutorials and projects. It provides a variety of courses covering different technologies and frameworks, enabling users to build real-world applications and enhance their coding expertise. Users can track their progress, participate in coding challenges, and collaborate with others in a supportive online community.',
    langs: ['React', 'tailwind css', 'bootstrap'],
    // gitLink: 'https://github.com/rachidelaid/rails-recipe-app',
    // liveLink: 'https://github.com/rachidelaid/rails-recipe-app',
  },
];
